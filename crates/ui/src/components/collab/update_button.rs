...
impl UpdateButton {
    ...
    pub fn checking() -> Self {
        Self::new(IconName::ArrowCircle, "Checking for Neo Zed updates…").icon_animate(true)
    }

    pub fn downloading(version: impl Into<SharedString>) -> Self {
        Self::new(IconName::Download, "Downloading Neo Zed update…").tooltip(version)
    }

    pub fn installing(version: impl Into<SharedString>) -> Self {
        Self::new(IconName::ArrowCircle, "Installing Neo Zed update…")
            .icon_animate(true)
            .tooltip(version)
    }
    ...
    pub fn errored(error: impl Into<SharedString>) -> Self {
        Self::new(IconName::Warning, "Failed to update Neo Zed")
