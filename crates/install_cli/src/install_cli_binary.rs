...
pub fn install_cli_binary(window: &mut Window, cx: &mut Context<Workspace>) {
    const LINUX_PROMPT_DETAIL: &str = "If you installed Neo Zed from our official release, add ~/.local/bin to your PATH so you can run `neozed`.\n\nIf you installed Neo Zed from a different source like your package manager, then you may need to create an alias or symlink manually.";
