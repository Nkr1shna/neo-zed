...
struct Args {
    ...
    #[cfg_attr(target_os = "macos", doc = "`~/Library/Application Support/NeoZed`.")]
    #[cfg_attr(target_os = "windows", doc = "`%LOCALAPPDATA%\\NeoZed`.")]
    #[cfg_attr(
...
mod mac_os {
    ...
    impl InstalledApp for Bundle {
        fn zed_version_string(&self) -> String {
            format!("NeoZed {} – {}", self.version(), self.path().display(),)
        }
