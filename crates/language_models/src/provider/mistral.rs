                        ...
                        MessageContent::ToolResult(tool_result) => {
                            let tool_content = match &tool_result.content {
                                ...
                                LanguageModelToolResultContent::Image(_) => {
                                    "[Tool responded with an image, but Neo Zed doesn't support these in Mistral models yet]".to_string()
                                }
                            };
    ...
    fn render(&mut self, _window: &mut Window, cx: &mut Context<Self>) -> impl IntoElement {
        ...
        if self.load_credentials_task.is_some() {
            ...
            v_flex()
                ...
                .child(Label::new("To use Neo Zed's agent with Mistral, you need to add an API key. Follow these steps:"))
                .child(
                    List::new()
                        .child(
                            ListBulletItem::new("")
