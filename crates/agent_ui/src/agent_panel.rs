...
use gpui::{
    ...
    KeyContext, Pixels, Size, Subscription, Task, Tiling, UpdateGlobal, WeakEntity,
    WindowBounds, WindowHandle, WindowKind, WindowOptions, point, prelude::*,
...
impl AgentPanel {
    ...
    pub(crate) fn new(
        ...
        let release_subscription = cx.on_release(|panel, cx| {
