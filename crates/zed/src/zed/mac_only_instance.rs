...
fn instance_handshake() -> &'static str {
    match *release_channel::RELEASE_CHANNEL {
        ReleaseChannel::Dev => "NeoZed Editor Dev Instance Running",
        ReleaseChannel::Nightly => "NeoZed Editor Nightly Instance Running",
        ReleaseChannel::Preview => "NeoZed Editor Preview Instance Running",
        ReleaseChannel::Stable => "NeoZed Editor Stable Instance Running",
    }
}
