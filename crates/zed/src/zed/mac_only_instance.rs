...
fn instance_handshake() -> &'static str {
    match *release_channel::RELEASE_CHANNEL {
        ReleaseChannel::Dev => "Neo Zed Dev Instance Running",
        ReleaseChannel::Nightly => "Neo Zed Nightly Instance Running",
        ReleaseChannel::Preview => "Neo Zed Preview Instance Running",
        ReleaseChannel::Stable => "Neo Zed Instance Running",
    }
}
