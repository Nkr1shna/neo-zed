...
Neo Zed uses select third-party subprocessors to deliver core product functionality. Each subprocessor processes customer personal data only as necessary to provide its service, and all are subject to appropriate data protection agreements.

### How Neo Zed Uses Subprocessors

To provide fast, reliable, and secure functionality, Neo Zed relies on a small number of carefully vetted third-party subprocessors. These vendors help us deliver essential capabilities such as hosting, billing, analytics, real-time collaboration, and hosted AI features.

Each subprocessor only processes customer personal data as needed to provide its service.

Neo Zed maintains contracts and data protection agreements with all subprocessors, including GDPR-compliant terms where applicable. We do not sell customer data, and we do not share customer personal data with vendors for advertising or marketing purposes.

### AI Subprocessors

Neo Zed offers three modes for AI:

1. **Bring your own API key** — data goes directly from the customer to the model provider; Neo Zed does not process or store it.
2. [**External Agents**](https://neozed.dev/docs/ai/external-agents) — Neo Zed uses ACP to provide an enhanced experience with terminal-based AI code agents like Claude Code or OpenAI Codex. Data is not processed or stored by Neo Zed when using external agents.
3. **Neo Zed-hosted models** — Neo Zed sends customer prompts to one of its AI providers (listed below). These vendors act as subprocessors only for customers who choose this mode.

### Ongoing Updates

**Last Updated**: March 2, 2026

This subprocessor list is reviewed regularly. Neo Zed will notify customers of material changes in accordance with our [Terms](https://neozed.dev/terms) and [Privacy Policy](https://neozed.dev/privacy-policy).
...
| **Fivetran**         | Automates data pipeline integration (extract, transformation, and load services) for Neo Zed | United States |
...
## AI Services (Neo Zed-Hosted Models)

_These subprocessors apply only when customers opt to use Neo Zed's hosted AI models. When users supply their own API keys, or use external agents, data is sent directly to the provider and does not pass through Neo Zed's infrastructure._
