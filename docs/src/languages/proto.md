...
Proto/proto3 (Protocol Buffers definition language) support is available through the [Proto extension](https://github.com/Nkr1shna/neo-zed/tree/main/extensions/proto).
...
Or you can have zed directly invoke `clang-format` by specifying it as a [formatter](https://neozed.dev/docs/reference/all-settings#formatter) in your settings:
