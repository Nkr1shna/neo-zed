...
Each icon theme file should adhere to the JSON schema specified at [`https://neozed.dev/schema/icon_themes/v0.3.0.json`](https://neozed.dev/schema/icon_themes/v0.3.0.json).

Here is an example icon theme structure:

```json [icon-theme]
{
  "$schema": "https://neozed.dev/schema/icon_themes/v0.3.0.json",
  "name": "My Icon Theme",
  "author": "Your Name",
  "themes": [
    {
