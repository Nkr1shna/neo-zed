...
![Architectural overview of Zed Remote Development](https://neozed.dev/img/remote-development/diagram.png)
...
1. Download and install the latest [Neo Zed](https://neozed.dev/releases). You need at least Zed v0.159.
...
Please join the #remoting-feedback channel in the [Zed Discord](https://neozed.dev/community-links).
...
- [Remote Development on neozed.dev](https://neozed.dev/remote-development): Product
