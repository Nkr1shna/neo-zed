...
More icon themes are available from the Extensions page, which you can access via the command palette with `zed: extensions` or the [Neo Zed website](https://neozed.dev/extensions?filter=icon-themes).
