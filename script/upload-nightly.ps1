...
UploadToBlobStore -BucketName $bucketName -FileToUpload "target/neozed-$Architecture.exe" -BlobStoreKey "nightly/neozed-$Architecture.exe"
UploadToBlobStore -BucketName $bucketName -FileToUpload "target/neozed-$Architecture.exe" -BlobStoreKey "$version/neozed-$Architecture.exe"

Remove-Item -Path "target/neozed-$Architecture.exe" -ErrorAction SilentlyContinue
